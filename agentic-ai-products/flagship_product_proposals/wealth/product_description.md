...
![advisor dashboard](ui_mockups/advisor_dashboard.png)
![client intake data collection](ui_mockups/client_intake_data_collection.png)
![proposal approval compliance](ui_mockups/proposal_approval_compliance.png)
![proposal generation review](ui_mockups/proposal_generation_review.png)
![scenario analysis projection](ui_mockups/scenario_analysis_projection.png)