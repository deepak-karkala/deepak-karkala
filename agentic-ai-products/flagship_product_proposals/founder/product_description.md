...
* Trajectories: hypothesis → experiment design → landing copy → outreach → calls → follow-ups → CRM hygiene.
* Graders:
...
![artifacts management](ui_mockups/artifacts_management.png)
![chat interface](ui_mockups/chat_interface.png)
![experiment tracker](ui_mockups/experiment_tracker.png)
![project workspace](ui_mockups/project_workspace.png)
![trust ui citations approvals](ui_mockups/trust_ui_citations_approvals.png)