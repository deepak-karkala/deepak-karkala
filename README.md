...
### Currently Building at [Vavi Labs](https://www.vavilabs.com/)
...
- **[Tech Abstractions](https://www.techabstractions.com/):** AI/ML interview-prep platform focused on production reasoning, system design, LLM infrastructure, and applied practice; currently with a few dozen users on the waitlist.
- **Coding-agent plugins:**  for Claude Code, Codex, and Gemini CLI. Includes [Agentic AI engineering](https://www.agentic-ai-skills.vavilabs.com/) and [Production MLOps](https://www.production-mlops-skills.vavilabs.com/) workflows with specialist agents, slash commands, architecture reviews, eval scorecards, rollout-readiness checks, governance checklists, and project handoff artifacts.
- **Explainers:** Interactive illustrated guides on [LLM inference](https://illustrated-llm-inference.vercel.app/), [coding agents](https://illustrated-series.vercel.app/), [RLHF](https://illustrated-rlhf.vercel.app/), and [statistics for MLOps](https://stats-for-mlops.vercel.app/).
- **Fine-tuning:** Published Gemma-3 1B projects for [Sitcom Scriptwriter](https://www.vavilabs.com/fine-tuning/ai-sitcom-scriptwriter/) and [Feynman-style Kannada Physics Tutor](https://www.vavilabs.com/fine-tuning/ai-feynman-kannada-tutor/), with custom datasets, staged SFT/RFT workflows, RAG grounding, LLM-as-judge evaluation, and qualitative output analysis.
- **[Corporate training](https://www.vavilabs.com/training/):** Course material for agentic AI leadership, engineering AI agents, MLOps production systems, harness engineering, and LLM inference engineering, including outlines, slide decks, assessments, and workbook-style artifacts.


### Past Work


Previously for a mid-sized European e-commerce marketplace, I built 4 production ML systems:
...
<!--
## Explore My Work
- [Currently Building at Vavi Labs](#currently-building-at-vavi-labs)
- [Playbooks](#playbooks)
